...
<hr />
<p><small> [1]. O foco do curso são testes e por isso a aplicação já estará pronta.  Os testes serão introduzidos durante as aulas.  Todo o código-fonte estará a disposição do aluno.</small></p>
